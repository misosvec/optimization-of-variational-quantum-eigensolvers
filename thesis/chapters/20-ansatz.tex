...
\todo{drawbacks, may be very expressive --> difficult to find params}\\
...
\todo{clearly explain what is the difference between linear and pairwise entanglement because they look very similar}
\begin{figure}[H]
...
\end{figure}
\todo{consider adding SCA (shifted circular alternating) and reverse linear}
