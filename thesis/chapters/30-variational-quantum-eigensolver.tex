...
\ques{I don't know how deep I should go with the gradient. It is not part of the bachelor computer science computer science study plan. We were told that bachelor's thesis should be written in such a way that a graduate with a bachelor's degree in computer science can understand it. Should I write it formally, as it can be found in a book, or just briefly summarize the idea? Do we want to go into the details of specific algorithms? We have 15 of them and thats quite a lot.}
...
\todo{Namiesto stack overflowu pridaj toto}
\todo{https://quantumcomputing.stackexchange.com/questions/24509/why-do-we-decompose-the-hamiltonian-into-pauli-strings-to-measure-the-expectatio}